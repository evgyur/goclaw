...
type TelegramConfig struct {
	...
	OnboardingEnabled bool                `json:"onboarding_enabled,omitempty"` // deterministic /start, /help and inline onboarding actions
	...
	STTProvider       string `json:"stt_provider,omitempty"`        // direct STT provider (e.g. "groq")
	STTModel          string `json:"stt_model,omitempty"`           // STT model for direct providers
	STTAPIKey         string `json:"stt_api_key,omitempty"`         // Bearer token for the STT proxy/direct provider
